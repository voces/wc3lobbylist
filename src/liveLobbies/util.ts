...
import { GuildChannel, Channel, TextChannel } from "discord.js";
...
export const isChannelGuildChannel = ( channel: Channel ): channel is GuildChannel =>
	( channel as GuildChannel ).guild !== undefined;
